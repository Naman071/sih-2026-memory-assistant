  ...
  medium: [
    {
      ...
      startHolder: 'A',
      finalHolder: 'C',
      fingerprint: 'ubi_4_A_A-C-D-B-C_4',
    },
    {
      id: 'ubi_m_02',
      difficulty: 'medium',
      ...
      startHolder: 'B',
      finalHolder: 'D',
      fingerprint: 'ubi_4_B_B-D-A-C-D_4',
    },
    {
      id: 'ubi_m_03',
      difficulty: 'medium',
      ...
      startHolder: 'C',
      finalHolder: 'A',
      fingerprint: 'ubi_4_C_C-A-B-D-A_4',
    },
    {
      id: 'ubi_m_04',
      difficulty: 'medium',
      ...
      startHolder: 'D',
      finalHolder: 'B',
      fingerprint: 'ubi_4_D_D-B-C-A-B_4',
    },
    {
      id: 'ubi_m_05',
      difficulty: 'medium',
      ...
      startHolder: 'A',
      finalHolder: 'D',
      fingerprint: 'ubi_4_A_A-B-D-C-A-D_5',
    },
  ],
  hard: [
    {
      ...
      difficulty: 'hard',
      playerCount: 5,
      passes: ['A', 'D', 'B', 'E', 'C', 'A', 'E'],
      startHolder: 'A',
      finalHolder: 'E',
      fingerprint: 'ubi_5_A_A-D-B-E-C-A-E_6',
    },
    {
      id: 'ubi_h_02',
      difficulty: 'hard',
      playerCount: 5,
      passes: ['B', 'E', 'C', 'A', 'D', 'B', 'D'],
      startHolder: 'B',
      finalHolder: 'D',
      fingerprint: 'ubi_5_B_B-E-C-A-D-B-D_6',
    },
    {
      id: 'ubi_h_03',
      difficulty: 'hard',
      playerCount: 5,
      passes: ['C', 'A', 'D', 'B', 'E', 'C', 'B'],
      startHolder: 'C',
      finalHolder: 'B',
      fingerprint: 'ubi_5_C_C-A-D-B-E-C-B_6',
    },
    {
      id: 'ubi_h_04',
      difficulty: 'hard',
      playerCount: 5,
      passes: ['D', 'B', 'E', 'C', 'A', 'D', 'C'],
      startHolder: 'D',
      finalHolder: 'C',
      fingerprint: 'ubi_5_D_D-B-E-C-A-D-C_6',
    },
  ],
};
