...
export default function PatientGamesScreen({ onBack }) {
  ...
  const games = [
    ...
    {
      id: 'ubilakapki',
      title: '🥥 Ubilakapki Toss',
      tagline: 'Watch the circle, remember who holds the coconut',
      category: 'Coconut Passing Game',
      badgeColor: '#B45309',
      badgeBg: '#FDE68A',
      icon: 'ellipse',
    },
    {
      id: 'northeast',
      title: '🏞️ North East Memory',
      tagline: 'Observe scenic photos and recall details',
      category: 'Visual Detail Recall',
      badgeColor: '#059669',
      badgeBg: '#D1FAE5',
      icon: 'images',
    },
    ...
    },
    {
      ...
      tagline: 'Listen to folklore and answer questions',
      category: 'Narrative Recall',
      badgeColor: '#7C3AED',
      badgeBg: '#EDE9FE',
      icon: 'book',
    },
